  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-[#151030] rounded-2xl sm:w-[500px] w-full  shadow-lg" style={{boxShadow: "0px 35px 120px -15px #211e35",}}
      >
        ...
        <div className="flex items-center justify-center mt-3 p-2">
          ...
          <div className="flex justify-between w-full gap-4 p-3">
            {/* Live demo Link  */}
            <a href={live_demo_link} target="_blank" className="flex items-center font-medium gap-2 cursor-pointer hover:text-gray-300 "><span className="flex justify-center items-center rounded-full bg-blue-950 w-9 h-9 p-2"><IconExternalLink/></span>Live Demo</a>
            {/* Divider */}
            <div className="w-[1px] h-10 bg-blue-950" />
            {/* Source Code Link  */}
            <a href={source_code_link} target="_blank" className="flex items-center font-medium gap-2 cursor-pointer hover:text-gray-300 "><span className="flex justify-center items-center rounded-full bg-gray-600 w-9 h-9 p-2"><IconBrandGithub/></span>View Code</a>
